...
class BaseOptions():
	...
	self.parser.add_argument('--which_direction1', type=str, default='dir1', help='AtoB or BtoA')
	self.parser.add_argument('--which_directions', type=str, default='dir2', help='AtoB or BtoA')
